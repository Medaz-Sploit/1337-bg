...
/*   Updated: 2020/02/25 22:30:10 by mazoukni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define WS wpz.width.state
# define WV wpz.width.value
# define PS wpz.prec.state
# define PV wpz.prec.value
# define ZS wpz.zero.state
# define ZV wpz.zero.value
# define F format
# define LEN length
# define I integer
